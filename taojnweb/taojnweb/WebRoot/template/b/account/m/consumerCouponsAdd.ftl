...
<script language="JavaScript">
    $(document).ready(function(){
     	var fm=new BackUrlForm("validateForm","新增赠送券","${base}/manage/account/sendRules.htm");
    });
</script>
</head>
<body>
  <!--表单正文开始-->
            <div class="page-main">
                ...
                <div class="page-item form-panel">
                   <form action="${base}/manage/account/consumerCoupons!save.htm" id="validateForm" method="post" >
                        <ul>
                           <li><span class="lab-title">券名称</span>
                                <div class="form-item">
                                   ...
                                   <input name="conConsumerCoupons.ruleId" type="hidden" class="text" size="30" value="${sendRules.id!}"  validate="{required:true,maxlength:20}" />
                                   <input name="id" type="hidden" class="text" size="30" value="${sendRules.id!}"  validate="{required:true,maxlength:20}" />
                                   <input name="conConsumerCoupons.sendName" type="hidden" class="text" size="30" value="${sendRules.sendName!}"  validate="{required:true,maxlength:20}" />
                                </div>
                            </li>
                           <li><span class="lab-title">价值</span>
                             ...
                             <li><span class="lab-title">失效时间</span>
                                <div class="form-item">
                                    <input name="conConsumerCoupons.expiratDate"  class="text" value="" size="30" onclick="WdatePicker({isShowClear:false,readOnly:true,skin:'blue'})" validate="{required:true}"/>
                                </div>
                            </li>
