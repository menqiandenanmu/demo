...
<script language="JavaScript">
    $(document).ready(function(){
     	var fm=new BackUrlForm("validateForm","审核通过","${base}/manage/account/electronicCoup!audit.htm");
    });
</script>
</head>
<body>
  <!--表单正文开始-->
            <div class="page-main">
                <div class="page-item page-title">审核电子券</div>
                <div class="page-item form-panel">
                   <form action="${base}/manage/account/electronicCoup!auditSave.htm" id="validateForm" method="post" >
                        <ul>
                          <input type="hidden" value="${ids}" name="ids">
                            <li><span class="lab-title">审核说明</span>
                                <div class="form-item">
                                    <textarea name="electronicCoup.auditRemark" id=""  class="textArea" validate="{required:true,maxlength:500}"></textarea>
                                </div>
                            </li>
                        </ul>
