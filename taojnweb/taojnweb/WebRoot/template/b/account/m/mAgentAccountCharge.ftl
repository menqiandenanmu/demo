...
<script language="JavaScript">
    $(document).ready(function(){
     	var fm=new BackUrlForm("validateForm","人工充值","${base}/manage/account/mAgentAccount.htm");
    });
</script>
</head>
<body>
<!--表单正文开始-->
            <div class="page-main">
                <div class="page-item page-title">人工充值</div>
                <div class="page-item form-panel">
    	<ul>
        <li>账户信息</li>
        </ul>
    <form action="${base}/manage/account/mAgentAccount!doArtificialCharge.htm" id="validateForm" method="post" >
 	<ul>
          <li><span class="lab-title">账户名称：</span>
          <div class="form-item">
      ...
      <li><span class="lab-title">余额：</span>
          ...
          <div class="form-item">
		   ...
		   <ul>
		        ...
		        <ul>
		         <li><span class="lab-title">本次充值：</span>
		          <div class="form-item">
		        ...
		        <li><span class="lab-title">备注：</span>
		          <div class="form-item">
			         <textArea name="tradeAccountDetail.remark" id="remark" rows="5" class="textArea" cols="30" validate="{required:true,maxlength:200}"></textArea>
		          </div>
		        </li>
    		 </ul>
