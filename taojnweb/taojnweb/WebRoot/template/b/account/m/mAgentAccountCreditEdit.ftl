...
<script language="JavaScript">
    $(document).ready(function(){
     	var fm=new GeneralForm("validateForm","用户余额警戒线修改");
    });
</script>
</head>
<body>
...
<div class="r_ContentNav">
    ...
    <form action="${base}/manage/account/mAgentAccount!doCreditSave.htm" id="validateForm" method="get" >
    <div class="r_content">
    <div class="tool_1">用户余额警戒线管理</div>
    ...
    <div class="r_content">
    	<div class="tool_1">余额警戒线管理</div>
	    <div class="tableNav_2">
	      <table class="tablelistNav" border="0" cellpadding="0" cellspacing="0" >
    		<tr>
    			<td align="center" >&nbsp;&nbsp;余额警戒线：</td>
    			<td align="left"><input type="text" name="opValue" value="${tradeAccount.creditLine?c}"  style="text-align: right" validate="{required:true,number:true,min:0}"/></td>
    		</tr>
    		<tr>
