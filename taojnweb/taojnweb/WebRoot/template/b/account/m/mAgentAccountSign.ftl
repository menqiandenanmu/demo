...
<script language="JavaScript">
    $(document).ready(function(){
     	var fm=new GeneralForm("validateForm","用户签单");
    });
</script>
</head>
<body>
...
<div class="r_ContentNav">
    ...
    <form action="${base}/manage/account/mAgentAccount!doSignSave.htm" id="validateForm" method="get" >
    <div class="r_content">
    <div class="tool_1">用户签单</div>
    ...
    <div class="r_content">
    	<div class="tool_1">签单</div>
	    <div class="tableNav_2">
	      <table class="tablelistNav" border="0" cellpadding="0" cellspacing="0" >
    		<tr>
    			<td align="center" >&nbsp;&nbsp;本次签单：</td>
    			<td align="left"><input type="text" name="signAmount" id="signAmount" style="text-align: right" validate="{required:true,number:true,min:1}"/></td>
    		</tr>
    		<tr>
