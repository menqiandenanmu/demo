...
<!--列表正文开始-->
    <div class="page-main">
        <div class="page-item page-title">退款记录</div>
        <!--索搜区域-->
		<form action="${base}/manage/account/reback.htm" id="searchForm" method="get" >
 ...
 <ul class="search-list clearfix">
  <li><span class="lab-title">商户名称</span><span>
			...
			<input type="text"  name="tradeAccountDetail.accountName" value="${tradeAccountDetail.accountName!}" class="text text-small" size="20"/>
			</span></li>
			...
			<input type="text"  name="tradeAccountDetail.opLoginName" value="${tradeAccountDetail.opLoginName!}" class="text text-small" size="20"/>
			</span></li>
       ...
       <!--列表操作区域-->
        ...
        <input type="button" class="btn btn-small bg-blue" onClick="location.href='${base}/manage/account/mAgentAccount!backExport.htm?${queryString}'" value="导出">
        </div>
        </form>
        <!--列表操作区域结束-->
 	<!--列表-->
