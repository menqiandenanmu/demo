...
<script language="JavaScript">
    ...
    function deleteMessage(){
		 ...
		 function updateMessage(){
		  ...
		  location.href = "${base}/manage/account/rechageCard!toAudit.htm?ids="+messageIds;
		 }
...
<!--列表正文开始-->
    <div class="page-main">
        <div class="page-item page-title">充值卡审核</div>
        <!--索搜区域-->
		<form action="${base}/manage/account/rechageCard!audit.htm" id="searchForm" method="get" >
 		  ...
 		  <ul class="search-list clearfix">
            <li><span class="lab-title">名称:</span><span>
			  ...
			  <li><span class="lab-title">卡号:</span><span>
				<span><input type="text" name="rechageCard.cardType" class="text text-small" value="${rechageCard.cardType!}" />
			</span>
			</li>
			 <li><span class="lab-title">充值卡类型:</span><span>
			...
			<li><span class="lab-title">状态:</span><span>
				<select name="rechageCard.status"  style="width:180px;">
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;" dialog="{width:900,height:550}" onclick="location.href='${base}/manage/account/rechageCard!auditById.htm'" class="btn btn-small bg-blue" id="add-btn">批量审核</a>
        </div>
        </form>
 	<!--列表-->
        ...
        <form action="${base}/manage/account/rechageCard!delAll.htm" id="messageForm" name="messageForm" method="post" >
	    	...
	    	<#list pages.result as res>
			    ...
			    <#if res.auditSyatus==0><input type="checkbox" name="messageIds" value="${res.id?if_exists}"></input></#if></td>
			      ...
			      <td align="center">${res.auditPerson?default("---")}</td>
			      <td align="center">
			     <#if res.auditSyatus==0> &nbsp;<a href="${base}/manage/account/rechageCard!toAudit.htm?ids=${res.id}">审核</a></#if>
			      </td>
			    </tr>
			</#list>
			<#if flag=0>
