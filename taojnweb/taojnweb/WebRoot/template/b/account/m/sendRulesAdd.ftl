...
<script language="JavaScript">
    $(document).ready(function(){
     	var fm=new BackUrlForm("validateForm","新增活动规则","${base}/manage/account/sendRules.htm");
    });
...
<body>
  <!--表单正文开始-->
            <div class="page-main">
                <div class="page-item page-title">活动规则新增</div>
                <div class="page-item form-panel">
                   <form action="${base}/manage/account/sendRules!save.htm" id="validateForm" method="post" >
                        <ul>
                           ...
                           <li><span class="lab-title">使用渠道</span>
                             ...
                             <li><span class="lab-title">开始时间</span>
                                <div class="form-item">
                                   <input name="sendRules.beginTime"  class="text" size="15" value="${sendRules.beginTime!}" onclick="WdatePicker({isShowClear:false,readOnly:true,skin:'blue',dateFmt:'yyyy-MM-dd'})" validate="{required:true,maxlength:20}" />
                                </div>
                            </li>
                             <li><span class="lab-title">结束时间</span>
                                <div class="form-item">
                                    <input name="sendRules.endTime"  class="text" value="" size="30" onclick="WdatePicker({isShowClear:false,readOnly:true,skin:'blue'})" validate="{required:true}"/>
                                </div>
                            </li>
