...
<!--列表正文开始-->
    <div class="page-main">
        <div class="page-item page-title">单边退款</div>
        <!--索搜区域-->
		<form action="${base}/manage/account/singlePurchase.htm" id="searchForm" method="get" >
        ...
        <div class="page-item list-panel">
	    	...
	    	<#list accountPages.result as res>
			    ...
			    <tr  id="${res.id}">
			      ...
			      <td align="center"><a href="javascript:common.doPost('${base}/manage/account/singleRefund.htm?id=${res.id}','确定退款吗?');">单帐退款</a></td>
			    </tr>
			</#list>
			<#if flag=0>
			    <tr>
