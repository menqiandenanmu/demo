...
<script language="JavaScript">
    $(document).ready(function(){
     	var fm=new BackUrlForm("validateForm","修改商户","${base}/manage/account/storeInfo.htm");
    });
...
<body>
  <!--表单正文开始-->
            <div class="page-main">
                <div class="page-item page-title">商户修改</div>
                <div class="page-item form-panel">
                   <form action="${base}/manage/account/storeInfo!update.htm" id="validateForm" method="post" >
                   <input name="id" hidden class="text" size="30" value="${storeInfo.id!}"  validate="{required:true}" />
                        <ul>
                           ...
                           <li><span class="lab-title">联系人电话</span>
                              ...
                              <li><span class="lab-title">商户电话</span>
                                <div class="form-item">
