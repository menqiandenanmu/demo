...
<script language="JavaScript">
    $(document).ready(function(){
     	var fm=new BackUrlForm("validateForm","修改积分规则","${base}/manage/point/pointRule.htm");
    });
</script>
</head>
<body>
  <!--表单正文开始-->
            <div class="page-main">
                <div class="page-item page-title">修改积分规则</div>
                <div class="page-item form-panel">
                   <form action="${base}/manage/point/pointRule!update.htm" id="validateForm" method="post" >
                   <input type="hidden" name="id"  class="text" size="30" value="${pointRule.id!}"  validate="{required:true}" />
                        <ul>
