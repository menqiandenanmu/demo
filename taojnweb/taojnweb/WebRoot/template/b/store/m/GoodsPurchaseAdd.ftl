...
$(document).ready(function(){
     	var fm=new GeneralForm("validateForm","添加库存");
    });
</script>
</head>
<body>
...
<div class="r_tit1">
	...
	<div class="r_content">
		<form action="${base}/manage/store/goodsPurchase!save.htm" id="validateForm" method="get" >
    ...
    <table width="100%" border="1" cellpadding="3" cellspacing="0" class="table_l_nav">
      <tr>
             ...
             <td class="table_l_td" align="left">
	          <input name="goodsPurchase.num" type="text" class="input_1_light" id="goodsPurchase.num" size="32" maxlength="50" validate="{required:true,digits:true,min:0}"/>
          	</td>
          	 </tr>
          	  <tr>
             <td align="right" class="table_l_tit">备注</td>
             <td class="table_l_td" align="left">
              <textarea rows="5" name="goodsPurchase.remark" cols="82" class="pwb_input2" ></textarea>
          	</td>
          	 </tr>
        </table>
        </div>
