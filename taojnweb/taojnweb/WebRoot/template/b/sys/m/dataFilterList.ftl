...
<link href="${base}/style/m/css/shangjia/skin.css" rel="stylesheet" type="text/css">
</head>
<body>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="17" height="29" valign="top" background="${base}/style/m/images/shangjia/mail_leftbg.gif"><img src="${base}/style/m/images/shangjia/left-top-right.gif" width="17" height="29" /></td>
    <td width="935" height="29" valign="top" background="${base}/style/m/images/shangjia/content-bg.gif"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">基本设置</div></td>
      </tr>
    </table></td>
    <td width="16" valign="top" background="${base}/style/m/images/shangjia/mail_rightbg.gif"><img src="${base}/style/m/images/shangjia/nav-right-bg.gif" width="16" height="29" /></td>
  </tr>
  <tr>
    <td height="71" valign="middle" background="${base}/style/m/images/shangjia/mail_leftbg.gif">&nbsp;</td>
        ...
        <td valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" height="55" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="10%" height="55" valign="middle"><img src="${base}/style/m/images/shangjia/title.gif" width="54" height="55"></td>
...
分</td>
    ...
    <td background="${base}/style/m/images/shangjia/mail_rightbg.gif">&nbsp;</td>
  </tr>
  <tr>
    <td valign="middle" background="${base}/style/m/images/shangjia/mail_leftbg.gif"><img src="${base}/style/m/images/shangjia/buttom_left2.gif" width="17" height="17" /></td>
      <td height="17" valign="top" background="${base}/style/m/images/shangjia/buttom_bgs.gif"><img src="${base}/style/m/images/shangjia/buttom_bgs.gif" width="17" height="17" /></td>
    <td background="${base}/style/m/images/shangjia/mail_rightbg.gif"><img src="${base}/style/m/images/shangjia/buttom_right2.gif" width="16" height="17" /></td>
  </tr>
</table>
