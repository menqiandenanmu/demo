...
<script language="JavaScript">
    $(document).ready(function(){
     	var fm=new BackUrlForm("validateForm","新增操作员角色","${base}/manage/sys/role.htm");
    });
</script>
</head>
<body>
  <!--表单正文开始-->
            <div class="page-main">
                <div class="page-item page-title">角色新增</div>
                <div class="page-item form-panel">
                   <form action="${base}/manage/sys/role!save.htm" id="validateForm" method="post" >
                        <ul>
                            <li><span class="lab-title">角色名称</span>
                                <div class="form-item">
                                   <input name="role.roleName" type="text" class="text" id="roleName" size="30" value=""  validate="{required:true}" />
                            ...
                            <li><span class="lab-title">描述</span>
                                <div class="form-item">
                                    <textarea name="role.remark" id="" class="textArea"></textarea>
                                </div>
                            </li>
                        </ul>
