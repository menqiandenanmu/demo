...
<script language="JavaScript">
    $(document).ready(function(){
     	var fm=new GeneralForm("validateForm","新增模块组");
    });
</script>
</head>
<body>
...
<div class="r_ContentNav">
    ...
    <form action="${base}/manage/sys/sysFunctionGroup!save.htm" id="validateForm" method="post" >
    <input type="hidden" name="sysFunctions.funType" value="0"/>
    <div class="tableNav_2">
      <table width="100%" border="1" cellpadding="3" cellspacing="0" class="table_l_nav">
        ...
        <tr>
          ...
          <td class="table_l_td">
	          <input name="sysFunctions.funUrl" type="text" class="input_1_light" id="sysFunctions.funUrl" value="" size="50" />
          </td>
        </tr>
        <tr>
