 ...
 * <li>资源文件<code>C.properties</code>也在Web Application中，只有servlet引擎的动态 <code>ClassLoader</code>可以找到它</li>
 * <li>类<code>B</code>调用工具类<code>A</code>的方法，希望通过类<code>A</code>取得资源文件 <code>C.properties</code></li>
 * </ul>
 * <p>
...
public class ClassLoaderUtil {
	 ...
	 *            服务名
	 * @param referrer
	 *            调用者类，如果为<code>null</code>，表示在<code>ClassLoaderUtil</code> 的class loader中找。
	 * @return service class
	 * @throws ClassNotFoundException
	 *             如果service class找不到，或装载service文件失败
	 */
	 ...
	 *            服务名
	 * @param classLoader
	 *            在指定classLoader中查找，如果为<code>null</code>，表示在 <code>ClassLoaderUtil</code>的class loader中找。
	 * @return service class
	 * @throws ClassNotFoundException
	 *             如果service class找不到，或装载service文件失败
	 */
	 ...
	 *            要实例化的类名
	 * @param referrer
	 *            调用者类，如果为<code>null</code>，则从<code>ClassLoaderUtil</code> 所在的class loader装载
	 * @return 指定类名的实例
	 * @throws ClassNotFoundException
	 *             如果类没找到
	 * @throws ClassInstantiationException
