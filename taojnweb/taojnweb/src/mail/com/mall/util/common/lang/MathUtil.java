...
public class MathUtil {
	 ...
	 * <ul>
	 * <li>
	 * If the argument is NaN, the result is NaN.</li>
	 * <li>
	 * If the argument is positive infinity, then the result is positive
	 * infinity.</li>
	 * <li>
	 * If the argument is negative infinity, then the result is positive zero.</li>
	 * </ul>
	 * 
	 * <p>
	 * A result must be within 1 ulp of the correctly rounded result. Results
	 ...
	 * 
	 * @return the value <i>e</i><sup><code>a</code></sup>, where <i>e</i> is
	 *         the base of the natural logarithms.
	 */
	 ...
	 * <ul>
	 * <li>
	 * If the argument is NaN or less than zero, then the result is NaN.</li>
	 * <li>
	 * If the argument is positive infinity, then the result is positive
	 * infinity.</li>
	 * <li>
	 ...
	 * 
	 * @param a
	 *            a number greater than <code>0.0</code>.
	 * 
	 ...
	 * the quotient <code>f1/f2</code>, and if two mathematical integers are
	 * equally close to <code>f1/f2</code>, then <i>n</i> is the integer that is
	 * even. If the remainder is zero, its sign is the same as the sign of the
	 * first argument. Special cases:
	 * 
	 * <ul>
	 * <li>
	 ...
	 * NaN.</li>
	 * <li>
	 * If the first argument is finite and the second argument is infinite, then
	 * the result is the same as the first argument.</li>
	 * </ul>
	 * 
	 * 
	 * @param f1
	 ...
	 * 
	 * @param a
	 *            a value. <!--@return the value &lceil;&nbsp;<code>a</code>
	 *            &nbsp;&rceil;.-->
	 * 
	 ...
	 * 
	 * @param a
	 *            a value. <!--@return the value &lfloor;&nbsp;<code>a</code>
	 *            &nbsp;&rfloor;.-->
	 * 
	 ...
	 * 
	 * @return the closest floating-point value to <code>a</code> that is equal
	 ...
	 * argument.</li>
	 * <li>
	 * If the second argument is NaN, then the result is NaN.</li>
	 * <li>
	 * If the first argument is NaN and the second argument is nonzero, then the
	 * result is NaN.</li>
	 * <li>
	 * If
	 * 
	 ...
	 * argument is positive infinity, or</li>
	 * <li>
	 * the absolute value of the first argument is less than 1 and the second
	 ...
	 * <li>
	 * the absolute value of the first argument is greater than 1 and the second
	 * argument is negative infinity, or</li>
	 * <li>
	 * the absolute value of the first argument is less than 1 and the second
	 ...
	 * <ul>
	 * <li>
	 * the first argument is positive zero and the second argument is greater
	 * than zero, or</li>
	 * <li>
	 * the first argument is positive infinity and the second argument is less
	 * than zero,</li>
	 * </ul>
	 * 
	 * then the result is positive zero.</li>
	 ...
	 * <ul>
	 * <li>
	 * the first argument is positive zero and the second argument is less than
	 * zero, or</li>
	 * <li>
	 ...
	 * <li>
	 * the first argument is negative infinity and the second argument is less
	 ...
	 * <ul>
	 * <li>
	 * the first argument is negative zero and the second argument is less than
	 * zero but not a finite odd integer, or</li>
	 * <li>
	 ...
	 * <ul>
	 * <li>
	 * if the second argument is a finite even integer, the result is equal to
	 * the result of raising the absolute value of the first argument to the
	 * power of the second argument</li>
	 * <li>
	 ...
	 * <li>
	 * if the second argument is finite and not an integer, then the result is
	 * NaN.</li>
	 * </ul>
	 * 
	 * </li>
	 ...
	 * {@link #floor <tt>floor</tt>}. A value is a fixed point of a one-argument
	 ...
	 * the value of <code>Integer.MIN_VALUE</code>, the result is equal to the
	 * value of <code>Integer.MIN_VALUE</code>.</li>
	 * <li>
	 * If the argument is positive infinity or any value greater than or equal
	 * to the value of <code>Integer.MAX_VALUE</code>, the result is equal to
	 * the value of <code>Integer.MAX_VALUE</code>.</li>
	 * </ul>
	 * </p>
	 * 
	 * @param a
	 ...
	 * rounded to an integer by adding 1/2, taking the floor of the result, and
	 * casting the result to type <code>long</code>. In other words, the result
	 * is equal to the value of the expression:
	 * 
	 * <p>
	 * 
	 ...
	 * <li>
	 * If the argument is negative infinity or any value less than or equal to
	 * the value of <code>Long.MIN_VALUE</code>, the result is equal to the
	 * value of <code>Long.MIN_VALUE</code>.</li>
	 * <li>
	 * If the argument is positive infinity or any value greater than or equal
	 * to the value of <code>Long.MAX_VALUE</code>, the result is equal to the
	 * value of <code>Long.MAX_VALUE</code>.</li>
	 * </ul>
	 * </p>
	 * 
	 * @param a
	 ...
	 * <ul>
	 * <li>
	 * If the argument is positive zero or negative zero, the result is positive
	 * zero.</li>
	 * <li>
	 * If the argument is infinite, the result is positive infinity.</li>
	 * <li>
	 * If the argument is NaN, the result is NaN.</li>
	 * </ul>
	 * 
	 ...
	 * same value, the result is that same value. If either value is NaN, then
	 * the result is NaN. Unlike the the numerical comparison operators, this
	 ...
	 * then the result is NaN. Unlike the the numerical comparison operators,
	 * this method considers negative zero to be strictly smaller than positive
	 * zero. If one argument is positive zero and the other negative zero, the
	 ...
	 * result is NaN. Unlike the the numerical comparison operators, this method
	 ...
	 * then the result is NaN. Unlike the the numerical comparison operators,
	 * this method considers negative zero to be strictly smaller than positive
	 * zero. If one argument is positive zero and the other is negative zero,
