package com.mall.util.common.lang.enumeration;
...
import com.mall.util.common.lang.enumeration.internal.EnumConstant;
import com.mall.util.common.lang.enumeration.internal.NumberType;

/**
 * 类型安全的枚举类型.
 * 
 * @author caedmon
 * @version $Id: ArrayUtil.java 2010-03-14
 */
...
public abstract class Enum extends Number implements NumberType, Comparable, Serializable {
	 ...
	 *            枚举量的值
	 * @param withValue
	 *            如果是<code>true</code>, 则该枚举量被赋予指定的值, 否则该枚举量将被赋予一个自动产生的值
	 */
	...
	public int compareTo(Object otherEnum) {
		if (!getClass().equals(otherEnum.getClass())) {
			throw new CreateEnumException(MessageFormat.format(EnumConstant.COMPARE_TYPE_MISMATCH,
					new Object[] { getClass().getName(), otherEnum.getClass().getName() }));
		}
