package com.mall.util.ibatis.sqlmap.engine.execution;
...
import com.mall.util.ibatis.jdbc.dialect.Dialect;
...
public class LimitSqlExecutor extends SqlExecutor {
	...
	public void setDialect(Dialect dialect) {
		if (dialect != null) {
			System.out
					.println("[iBATIS] set ibatis LimitSqlExecutor.dialect = "
