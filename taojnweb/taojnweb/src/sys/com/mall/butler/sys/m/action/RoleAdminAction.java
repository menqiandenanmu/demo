 ...
 * 类名称：RoleAdminAction
 * 创建人：caedmon
 * 创建时间：2013-5-8 下午10:15:26
 * 修改人：caedmon
 * 修改时间：2013-5-8 下午10:15:26
 * 修改备注：
 * 
 * @version
 */
public class RoleAdminAction extends ManageBaseAction {
	...
	public String execute() {
		...
		param.setCreateLoginId(getLoginId());
	...
	public String infoEdit() {
		...
		if (role == null) {
			...
			param.setFunAccType(role.getRoleAccType());
			List<SysFunctions> functionsL = mSysFunctionService.findFunctions(param);
			List<SysFunctions> distFunL = mRoleService.queryFuncByRole(role);
	...
	public String infoUpdate() {
		...
		if (role == null) {
			...
			mRoleService.doUpdateAdminRoleFuns(role, distL);
			msgInfo.setFlag(MessageDialog.SUCCESS);
